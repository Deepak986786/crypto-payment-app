...
import logo1 from "../../images/dlabslogormbg.png";
...
const Footer = () => (
  <div className="flex flex-col items-center justify-between w-full p-4 md:justify-center gradient-bg-footer">
    ...
    <div className="flex flex-col items-center justify-center mt-5">
      <p className="text-sm text-center text-white">Come and Explore miracles</p>
      <p className="mt-2 text-sm font-medium text-center text-white">D-Labs</p>
    </div>

    <div className="sm:w-[90%] w-full h-[0.25px] bg-gray-400 mt-5 " />

    <div className="sm:w-[90%] w-full flex justify-between items-center mt-3">
      <p className="text-xs text-left text-white">D-labs</p>
